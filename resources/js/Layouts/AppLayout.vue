        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <header v-if="$slots.header" class="bg-white shadow relative">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 ">
                    <slot name="header" />
                    <div v-if="$page.props.flash.message" id="toast-default" class="flex items-center p-2 w-full max-w-xs text-white bg-green-400 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 absolute right-2 top-3" role="alert">
                        ...
                        <div class="ml-3 text-sm font-bold">{{ $page.props.flash.message }}</div>
                        <button @click="closeToastr" type="button" class="ml-auto -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-default" aria-label="Close">

...
if(Inertia.page.props.flash.success){
    toast.success(Inertia.page.props.flash.success);
}
if(Inertia.page.props.flash.error){
    toast.error(Inertia.page.props.flash.error);
}
if(Inertia.page.props.flash.warning){
    toast.warning(Inertia.page.props.flash.warning);
}
if(Inertia.page.props.flash.message){
    toast.info(Inertia.page.props.flash.message);
}
const logout = () => {
...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="bg-white shadow relative">
